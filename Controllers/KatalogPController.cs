...
namespace ShopAPI.Controllers
{
   ...
   // [Authorize(Roles = Role.Manager)]
    ...
    public class KatalogPController : ControllerBase
    {
        private readonly KatalogPRepository _repository;
        public KatalogPController(KatalogPRepository repository)
        {
        ...
        [HttpPost]       
        public async Task<ActionResult<KatalogP>> Post()
        {
           

            KatalogP item = new KatalogP();
